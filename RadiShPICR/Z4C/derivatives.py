...
def first_derivative(field, dr, parity=-1):
    ...
    field_ = field_.at[0].set(field_[2] * parity)  # set the first point using parity
    field_ = field_.at[1].set(field_[3] * parity)  # set the second point using parity
...
def sixth_derivative(field, dr, parity=-1):
    ...
    field_ = field_.at[2].set(field_[5] * parity)  # set the third point using parity
